...
import 'package:ariya/app/models/models.dart';
...
class ExpirationDateScreen extends GetView<ExpirationDateController> {
  ...
  Widget _buildItemList(
      BuildContext context, ariyaTypography textTheme, ariyaColors colorTheme) {
  ...
  Widget _buildItem(BuildContext context, ExpirationDateItem item,
      ariyaTypography textTheme, ariyaColors colorTheme) {
