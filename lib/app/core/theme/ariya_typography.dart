...
class ariyaTypography extends ThemeExtension<ariyaTypography> {
  ...
  @override
  ThemeExtension<ariyaTypography> copyWith({
    Color? defaultColor,
    TextStyle? title,
    TextStyle? header1,
    TextStyle? header2,
  ...
  @override
  ThemeExtension<ariyaTypography> lerp(covariant ThemeExtension<ariyaTypography>? other, double t) {
    if (other is! ariyaTypography) {
      return this;
    }
    return ariyaTypography(
