...
class ariyaColors extends ThemeExtension<ariyaColors> {
  ...
  @override
  ThemeExtension<ariyaColors> copyWith({
    Color? grayscale100,
    Color? grayscale200,
    Color? grayscale300,
    Color? grayscale400,
  ...
  @override
  ThemeExtension<ariyaColors> lerp(covariant ThemeExtension<ariyaColors>? other, double t) {
    if (other is! ariyaColors) {
      return this;
    }
