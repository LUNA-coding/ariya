                                      ...
                                      ? SizedBox(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text(
                                                rank.$4.toString(),
                                                style: const TextStyle(color: Color(0xFFEB626B), fontSize: 16, fontFamily: 'SUITE', fontWeight: FontWeight.w500),
                                              ),
                                              const Icon(
                                                Icons.keyboard_arrow_up,
                                                color: Color(0xFFEB626B),
                                              )
                                            ],
                                          ),
                                        )
                                          ...
                                          ? SizedBox(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Text(
                                                    (-rank.$4).toString(),
                                                    style: const TextStyle(color: Color(0xFF1472EC), fontSize: 16, fontFamily: 'SUITE', fontWeight: FontWeight.w500),
                                                  ),
                                                  const Icon(
                                                    Icons.keyboard_arrow_down,
                                                    color: Color(0xFF1472EC),
                                                  )
                                                ],
                                              ),
                                            )
