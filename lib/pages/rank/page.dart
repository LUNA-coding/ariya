          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() => Column(
                  children: [...(isSchool.value ? schoolRankList : entireRankList).map((rank) => Padding(padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 0),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 16,),
                            SizedBox(width: 160, child: Text(rank.$2, style: const TextStyle(fontSize: 16, fontFamily: 'SUITE', fontWeight: FontWeight.w500), overflow: TextOverflow.ellipsis,)),
                          ],
                        ),
